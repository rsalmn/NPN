...
do
    ...
    -- Safely get all events
    local allEvents = {}
    pcall(function()
        allEvents = ActiveEventsCache:GetAll() or {}
    end)
    ...
    print("🔄 [ROTATION] Building queue from", table.concat(vim.tbl_keys(allEvents), ", "))
...
function RotationSystem:GetNextEvent()
    ...
    -- =========================================================
    -- =========================================================
-- 🔒 FIXED ACTIVE EVENTS CACHE SYSTEM
-- =========================================================
...
-- 🔧 FIX: Ensure GetAll never returns nil
...
function ActiveEventsCache:MarkVisited(eventName)
    ...
    -- =========================================================
    -- =========================================================
-- 🔍 FIXED PROBE FUNCTION WITH BETTER WORM LOGIC
-- =========================================================
local function ProbeAndFindEvent(targetName)
    ...
    -- WORM HUNTS WITH PROPER TELEPORT AND SEARCH
    if targetName == "Worm Hunt" or targetName == "Ghost Worm" then
        ...
        for i, pos in ipairs(coords) do
            ...
            if tpSuccess then
                ...
                -- Search for particles in larger radius
    ...
    -- OTHER EVENTS (Megalodon, Shark, etc.)
    ...
    while SmartEventState do
        local success, err = pcall(function()
            ...
            if hasActiveEvents then
                -- 🔧 FIXED: Use custom getTableKeys instead of vim.tbl_keys
