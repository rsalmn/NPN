...
do
    farm:Divider()
    local televent = farm:Section({ Title = "Smart Event (RETURN VALUES FIXED)", TextSize = 20 })
        ...
        if obj:IsA("Model") then
            ...
            if nameSuccess and modelName then
                ...
                if nameLower:find("hunt") or nameLower:find("event") or 
                   ...
                   nameLower:find("worm") or nameLower:find("ghost") then
                    return true
                end
            end
        end
    ...
    -- =========================================================
    -- 🔧 FIXED PROBE FUNCTION - PROPER RETURN VALUES
    -- =========================================================
    local function ProbeAndFindEvent(targetName)
        ...
        for i, pos in ipairs(coords) do
            ...
            task.wait(1.5) -- Wait for chunk load
            ...
            for _, radius in ipairs({200, 400, 600}) do
                ...
                if scanSuccess and parts then
                    ...
                    for _, part in ipairs(parts) do
                        -- =========================================================
                        -- 🎯 CHECK EACH PART FOR EVENT MATCH
                        -- =========================================================
                        local checkSuccess, eventFound = pcall(function()
                            ...
                            -- Check if part or parent name matches keywords
                            ...
                            if partMatch or parentMatch then
                                ...
                                if parent and parent:IsA("Model") and IsEventAlive(parent) then
                                    ...
                                    if modelPosSuccess and modelPos then
                                        ...
                                        eventPosition = part.Position -- Fallback to part position
                                    end
                                    
                                elseif IsEventAlive(part) then
                                    -- For parts that represent events directly
                                    eventModel = part
                                    eventPosition = part.Position
                                    print("    ✅✅✅ [EVENT PART CONFIRMED]", partName)
                                else
                                    print("    ⚠️ Match found but event not alive")
                                    return nil -- Not alive, continue searching
                                end
                        ...
                        if checkSuccess and eventFound then
                            ...
                            -- Return immediately when event is found
            ...
            task.wait(0.5) -- Brief delay before next spot
        end
    ...
    televent:Toggle({
        Title = "🔧 Smart Event (RETURN FIXED)",
        Desc = "Fixed return value extraction bug",
        Value = false,
        Callback = function(state)
            ...
            if SmartEventState then
                ...
                WindUI:Notify({ 
                    Title = "Smart Event", 
                    Content = "Started with fixed return values", 
                    Duration = 4 
                })
                
                print("\n🔧 === SMART EVENT SYSTEM (RETURN FIXED) STARTED ===")
                        ...
                        local success, err = pcall(function()
                            ...
                            if hasActiveEvents then
                                ...
                                if nextEvent then
                                    ...
                                    task.wait(15) -- Stay for 15 seconds
                                end
                                
                                task.wait(5)
                                return -- Skip scanning phase
                            end
                            ...
                            -- PHASE 3: FULL SCAN
                            -- =========================================================
                            print("\n📡 [SCANNING MODE] Looking for events...")
                            ...
                            for _, eventInfo in ipairs(eventsToCheck) do
                                ...
                                task.wait(2) -- Delay between scans
                            end
    ...
    print("🔧 [SMART EVENT] Loaded with fixed return values!")
end
